            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="https://technext.github.io/restoran/about.html" class="nav-item nav-link">About</a>
                        <a href="https://technext.github.io/restoran/service.html" class="nav-item nav-link">Service</a>
                        <a href="https://technext.github.io/restoran/menu.html" class="nav-item nav-link">Menu</a>
                        <div class="nav-item dropdown">
                            <a href="https://technext.github.io/restoran/index.html?_ga=2.217743574.1185720242.1666899791-1611977660.1656511782&amp;fbclid=IwAR2n-dhF9IeIpkS-L2m9orwaaOffYgwrOK-XcQcKY0tSvK4uN5uMV2XMgRg#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu m-0">
                                <a href="https://technext.github.io/restoran/booking.html" class="dropdown-item">Booking</a>
                                <a href="https://technext.github.io/restoran/team.html" class="dropdown-item">Our Team</a>
                                <a href="https://technext.github.io/restoran/testimonial.html" class="dropdown-item">Testimonial</a>
                            </div>
                        </div>
                        <a href="https://technext.github.io/restoran/contact.html" class="nav-item nav-link">Contact</a>
                    </div>
                    <?php
if (isset($_POST["con"]))
{?>
    <a href="listReservation.php" class="btn btn-primary py-2 px-4">Profile</a>  
    <?php
    }
    else
    {
        ?>
<a href="listReservation.php" class="btn btn-primary py-2 px-4">Connexion</a>
<?php
}
?>
                </div>
...
<center><input type="text" class="form-control" name="r" id="r" placeholder="Your Name"></center>
</form>
