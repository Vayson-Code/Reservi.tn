...
?>
              <!-- Responsive Table -->
              <div class="card">
                <h5 class="card-header">Restaux Table</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                  <thead>
        <tr>
        <th> <center><button ><a href="addRestau.php">addRestau</a></center></button></th>
...
?>
               ...
               <br>
               <div class="card">
                <h5 class="card-header">Reservation Table</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
                    <tr>
